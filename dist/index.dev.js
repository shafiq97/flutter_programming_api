...
var db = mysql.createConnection({
  ...
  user: 'root',
  password: '',
  database: 'flutter_quiz_programming'
}); // Connect to database
...
app.get('/api/data/html', function (req, res) {
  var sql = 'SELECT question, choice1, choice2, choice3, choice4, answer, image FROM questions WHERE category = "html"';
...
app.get('/api/data/cpp', function (req, res) {
  var sql = 'SELECT question, choice1, choice2, choice3, choice4, answer, image FROM questions WHERE category = "cpp"';
  db.query(sql, function (error, results, fields) {
    if (error) {
      console.error(error);
      return res.sendStatus(500);
...
app.get('/api/data/mysql', function (req, res) {
  var sql = 'SELECT question, choice1, choice2, choice3, choice4, answer, image FROM questions WHERE category = "mysql"';
  db.query(sql, function (error, results, fields) {
    if (error) {
      console.error(error);
      return res.sendStatus(500);
...
app.get('/api/data/java', function (req, res) {
  var sql = 'SELECT question, choice1, choice2, choice3, choice4, answer, image FROM questions WHERE category = "Java"';
  db.query(sql, function (error, results, fields) {
    if (error) {
      console.error(error);
      return res.sendStatus(500);
